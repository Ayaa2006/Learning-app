  ...
  const drawer = (
    <Box>
      <Box sx={{ 
        ...
        <Typography variant="h6" component={Link} to="/admin-dashboard" sx={{ fontWeight: 'bold', color: '#ff9900', textDecoration: 'none' }}>
          SkillPath Admin
        </Typography>
        {isMobile && (
      ...
      <List>
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemIcon>
              <DashboardIcon color={isActive('/admin-dashboard') ? 'primary' : 'inherit'} />
            </ListItemIcon>
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1 }}>
            {userRole === ROLES.ADMIN ? 'Administration' : 'Espace Professeur'}
          </Typography>
